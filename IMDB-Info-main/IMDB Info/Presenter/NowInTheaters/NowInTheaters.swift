...
final class NowInTheaters: UIViewController {
    ...
    private let nowInTheaters = "https://api.themoviedb.org/3/movie/now_playing?api_key=b688d2e3d40e21d185f1dd90d122a568&language=en-US&page=5"
    
    override func viewDidLoad() {
        super.viewDidLoad()
        tableView.backgroundColor = .black
        movieManager.fetchMovieList(with: nowInTheaters) { movielist in
            print("Movies fetched: \(movielist.results)")
